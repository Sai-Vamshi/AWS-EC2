...
from yellowant_api.models import UserIntegration, awsec2
import json
...
def userdetails(request):
    ...
    if request.user.is_authenticated:
        ...
        for user_integration in user_integrations:
            ...
            try:
                smut = awsec2.objects.get(id_id=user_integration.id)
...
def view_integration(request, id=None):
    ...
    smut = awsec2.objects.get(id_id=id)
    print(smut.AWS_update_login_flag)
