...
if DEV_ENV=="HEROKU":
    ...
    os.system('yellowant sync -q --api_url {}yellowant-api/ --website {} --install_page_url {} --privacy_policy_url {}privacy --redirect_uris {}yellowant-ouath-redirect/'.format(website,website,website,website,website))
    os.system('ls -al')
